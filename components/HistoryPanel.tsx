...
const HistoryPanel: React.FC<HistoryPanelProps> = ({ history, onSelectReport, onStartNew }) => {
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-slate-200 h-fit dark:bg-slate-800 dark:border-slate-700">
            <div className="flex justify-between items-center mb-6 pb-6 border-b border-slate-200 dark:border-slate-700">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-slate-900 dark:text-slate-200">Research History</h2>
                        <p className="text-slate-500 dark:text-slate-400">Select a previous report or start a new one.</p>
                    </div>
                </div>
                <button
                  onClick={onStartNew}
                       ...
                       <div className="min-w-0 flex-auto">
                            <div className="flex items-center gap-x-3">
                                <h3 className="text-base font-semibold leading-6 text-slate-900 dark:text-slate-100">
                                    <button onClick={() => onSelectReport(item)} className="hover:underline focus:outline-none">
